...
Java 1.8.0_144
Mosquitto 1.4.14
Apacha Kafka 0.11.0.1 (Compilado en Scala 2.11)
kafka-connect-mqtt 1.1
...
Por otra parte, es necesario descargar Kafka desde el sitio web oficial del proyecto de apache. Los binarios de la version descargada incluyen Zookeeper, por lo cual no es necesario descargarlo. En caso contrario, se recomienda descargar Zookeeper desde su sitio web oficial del proyecto de Apache.
...
También es necesario descargar una libreria adicional que podemos encontrar en los binarios del proyecto kafka-connect-mqt. Esta libreria tambien debe ser agregada a las librerias de Kafka
